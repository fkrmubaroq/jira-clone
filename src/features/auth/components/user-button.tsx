...
function AvatarLetter({ letter, className, classNameAvatarFallback }: { letter: string, className?: string; classNameAvatarFallback?: string }) {
    return <Avatar className={cn("size-10 hover:opacity-75 transition border border-neutral-300", className)}>
