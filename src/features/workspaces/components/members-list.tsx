...
import {
	...
	useGetMembers,
} from "@/features/members/api/user-get-members";
...
export default function MembersList() {
	...
	const {
		...
		showModal,
		hideModal,
	} = useModal<"confirmation-delete-member", string>();
						...
						<React.Fragment key={member.$id}>
							<div className="flex items-center gap-2">
								...
								<DropdownAction
									...
									onRemove={(memberId) =>
										showModal("confirmation-delete-member", memberId)
									}
